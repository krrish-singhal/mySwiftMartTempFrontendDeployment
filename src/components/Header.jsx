...
const Header = ({ cartCount, olxCartCount, user, isDark, toggleTheme }) => {
  ...
  const handleLogout = async () => {
    const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/userLogout`, {
      method: "GET",
      credentials: "include",
    });
              ...
              {reduxUser?._id ? (
                ...
                >
                  {reduxUser.profilePic ? (
                    <img
                      src={`${import.meta.env.VITE_BACKEND_URL}${reduxUser.profilePic}` || "/default-profile.png"}
                      alt="Profile"
